...
const TechStack: React.FC = () => {
  ...
  return (
    <section className="py-10 bg-white dark:bg-slate-950 border-b border-slate-200/60 dark:border-slate-800 overflow-hidden transition-colors duration-300">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 mb-6 text-center">
        <p className="text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest">
          Dibangun dengan Teknologi Standar Industri Modern
        </p>
      </div>
      
      <div className="relative w-full group hover-pause">
