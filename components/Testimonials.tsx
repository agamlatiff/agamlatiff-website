...
const Testimonials: React.FC = () => {
  ...
  const baseSet = [...TESTIMONIALS, ...TESTIMONIALS];
  ...
  return (
    <section id="testimonials" className="py-16 md:py-24 bg-slate-50 dark:bg-slate-950 transition-colors duration-300 overflow-hidden border-y border-slate-200/60 dark:border-slate-800">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 mb-10 md:mb-12">
        <div className="text-center max-w-2xl mx-auto">
           <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4 transition-colors">Apa Kata Mereka?</h2>
           <p className="text-slate-600 dark:text-slate-400 transition-colors">Kepercayaan adalah mata uang utama dalam bisnis freelance.</p>
        </div>
      </div>

      {/* Marquee Container */}
      <div className="relative hover-pause group w-full">
