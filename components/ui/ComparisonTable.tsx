  ...
  return (
    <div className="w-full mt-16">
      ...
      <div className="relative">
        {/* Scroll Hint Overlay (Right) */}
        <div className="absolute top-0 right-0 h-full w-8 bg-gradient-to-l from-white dark:from-slate-900 to-transparent pointer-events-none z-20 md:hidden"></div>
        ...
        <div className="overflow-x-auto pb-6 -mx-4 px-4 md:mx-0 md:px-0">
          <div className="min-w-[800px] bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <div className="grid grid-cols-4 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800">
              <div className="p-6 flex items-center sticky left-0 bg-slate-50 dark:bg-slate-800 z-10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]">
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
              {rows.map((row, index) => (
                ...
                >
                  <div className="p-4 md:p-6 flex items-center gap-2 sticky left-0 bg-white dark:bg-slate-900 z-10 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)]">
