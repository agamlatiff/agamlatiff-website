    ...
    <section id="faq" className="py-20 bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
           ...
           <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4 transition-colors">Pertanyaan Umum</h2>
           <p className="text-slate-600 dark:text-slate-400">Hal-hal yang sering ditanyakan klien sebelum memulai kerjasama.</p>
        </div>
