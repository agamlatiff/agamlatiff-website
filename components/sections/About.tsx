...
const About: React.FC = () => {
  ...
  const DNA_VALUES = [
    { text: "Simpel & Praktis", icon: Layout, desc: "Sistem langsung dipakai staf, minim training." },
    { text: "Cepat Selesai", icon: Zap, desc: "Pengerjaan hitungan hari, bukan bulan." },
    { text: "Hak Milik 100%", icon: ShieldCheck, desc: "Bukan sewa, sistem jadi aset Anda selamanya." },
    { text: "Harga Transparan", icon: CheckCircle2, desc: "Paket jelas di awal, tanpa biaya tersembunyi." },
    { text: "Solusi Nyata", icon: BarChart, desc: "Fokus beresin masalah, bukan cuma fitur canggih." },
  ];
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          ...
          >
             ...
             >
               Siapa Agam? <br/>
               <span className="text-primary">Partner Digital Bisnis Anda.</span>
             </motion.h2>
             ...
             >
               <p className="font-medium text-slate-800 dark:text-slate-200 italic border-l-4 border-primary pl-4">
                 "Saya Agam, freelance developer yang bantu UMKM menyelesaikan masalah operasional lewat sistem digital yang ringan, cepat, dan mudah dipakai."
               </p>
               <p>
                 Fokus saya sederhana: <strong>bikin usaha Anda lebih tertata</strong> supaya Anda bisa fokus jualan, bukan pusing mengurus ribetnya catatan manual dan data yang berantakan.
               </p>
               <p>
                 Saya tidak menjual 'kodingan' yang rumit. Saya menjual <strong>solusi bisnis</strong> agar operasional Anda rapi, stok aman, dan profit terukur.
               </p>
             </motion.div>

             <motion.div variants={fadeInUpVariants}>
               <h3 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider mb-4 transition-colors">
                   Kenapa UMKM Pilih Agam?
               </h3>
               <div className="grid grid-cols-1 gap-3 not-prose mb-8">
                  {DNA_VALUES.map((item, idx) => {
