      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-6">
            Perbandingan Investasi & Fitur
          </h2>
          <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
            Jangan terjebak biaya langganan yang membengkak. Bandingkan bagaimana <strong>Custom Development</strong> memberikan ROI terbaik untuk jangka panjang.
          </p>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-950">
                  ...
                  <th className="p-6 text-lg font-bold text-slate-600 dark:text-slate-300 w-1/4 text-center">Digital Agency</th>
                  <th className="p-0 w-1/4 relative">
                    ...
                    <div className="relative p-6">
                        ...
                        <div className="text-xs text-center text-primary/80 font-bold mt-1 uppercase tracking-wide">Best Value</div>
                    </div>
                  </th>
                </tr>
              </thead>
        ...
        <div className="md:hidden flex flex-col gap-8">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl shadow-primary/10 border-2 border-primary overflow-hidden relative transform scale-105">
                <div className="absolute top-0 right-0 bg-primary text-white px-3 py-1 rounded-bl-xl text-xs font-bold">WINNER</div>
                <div className="bg-primary/5 p-6 border-b border-primary/10">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400">
                      Pilihan terbaik untuk bisnis yang ingin berkembang tanpa batasan fitur dan biaya bulanan.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 gap-4 opacity-90">
                <div className="bg-white dark:bg-slate-900 rounded-xl p-5 border border-slate-200 dark:border-slate-800">
                    <h3 className="font-bold text-slate-500 text-center mb-4 flex items-center justify-center gap-2"><Layout size={16} /> Aplikasi SaaS</h3>
                     {COMPARISON_DATA.map((row, idx) => (
