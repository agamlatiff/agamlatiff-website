      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed transition-colors">
            Saya menerapkan alur kerja terstruktur (SDLC) untuk memastikan sistem yang Anda terima <strong>stabil, aman, dan sesuai kebutuhan</strong> bisnis. Transparan dari kontrak hingga serah terima.
          </p>
        </div>
        ...
        >
             <div className="inline-block p-1 bg-slate-100 dark:bg-slate-800 rounded-full mb-6">
                <div className="bg-white dark:bg-slate-900 rounded-full px-6 py-2 text-sm text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700">
                    Sistem siap dipakai dalam <strong className="text-primary">2 - 4 Minggu</strong> (Tergantung Kompleksitas)
                </div>
             </div>
             <br />
             <a 
             ...
             >
                Mulai Diskusi Project <ArrowRight size={20} />
             </a>
        </div>
      </div>
    </section>
