      ...
      <div className="relative z-10 max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col items-center text-center">
             ...
             >
               ...
               <span className="uppercase tracking-widest">Investasi Sekali Bayar</span>
             </motion.div>
             ...
             >
               Sistem Kasir (POS) & Inventory Custom. <strong className="text-slate-900 dark:text-white">Bayar Sekali, Pakai Selamanya.</strong><br className="hidden sm:block"/> 
               Stop buang uang untuk langganan bulanan. Miliki aset sistem sendiri yang hemat dan aman.
             </motion.p>
             ...
             >
                ...
                >
                   <TrendingUp size={18} /> Cek Simulasi Rugi
                </a>
             </motion.div>
