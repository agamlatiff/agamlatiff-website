        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight text-slate-900 dark:text-white transition-colors">
              Mau Jadi Pebisnis Tipe Apa?
            </h2>
            <p className="text-slate-600 dark:text-slate-300 text-lg mb-8 leading-relaxed transition-colors">
              Lihat perbedaan nasib bisnis yang bertahan dengan cara lama vs bisnis yang beradaptasi dengan teknologi.
            </p>
            ...
            <div className="space-y-4">
                ...
                <div 
                    ...
                    className={`cursor-pointer p-5 rounded-xl border-2 transition-all duration-300 relative overflow-hidden ${
                        !isDigital 
                    ...
                    <div className="flex items-start gap-4 relative z-10">
                        ...
                        <div>
                            <h4 className={`font-bold text-lg mb-1 ${!isDigital ? 'text-red-700 dark:text-red-400' : 'text-slate-600 dark:text-slate-400'}`}>
                                Tipe A: 'Saya Gaptek / Cara Lama'
                            </h4>
                            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                Masih catat manual, owner merangkap admin, stok sering selisih tapi dimaklumi.
                                <br/><strong className="text-red-500 mt-1 block">• Efek: Bisnis jalan di tempat, Owner tidak bisa libur.</strong>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex items-start gap-4 relative z-10">
                        ...
                        <div>
                            <h4 className={`font-bold text-lg mb-1 ${isDigital ? 'text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400'}`}>
                                Tipe B: 'Saya Mau Adaptasi'
                            </h4>
                            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                                Sistem otomatis, stok tercatat real-time, laporan masuk ke HP owner tiap malam.
                                <br/><strong className="text-green-600 dark:text-green-400 mt-1 block">• Efek: Mudah buka cabang, Profit maksimal.</strong>
                            </p>
                        </div>
                    </div>
                </div>
          ...
          <motion.div 
             ...
             className={`rounded-3xl shadow-2xl p-6 md:p-8 border transition-all duration-500 relative overflow-hidden ${
              !isDigital 
            ...
            <div className="flex justify-between items-center mb-8 border-b border-slate-100 dark:border-slate-700 pb-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="text-xs font-bold uppercase tracking-wider opacity-60 text-slate-500 dark:text-slate-400">Cek Potensi Kerugian</div>
                        <div className={`font-bold text-lg ${!isDigital ? 'text-red-600' : 'text-slate-900 dark:text-white'}`}>
                            {!isDigital ? "Resiko Manual" : "Potensi Digital"}
                        </div>
                    </div>
                </div>
                <button 
            ...
            <div className="mb-8">
                <div className="flex justify-between mb-3 text-sm font-medium">
                  ...
                  <span className={`font-bold px-3 py-1 rounded-lg ${
                      !isDigital ? 'bg-red-50 text-red-600' : 'bg-green-500/20 text-green-500'
                  }`}>
                ...
                <input 
                  ...
                  className={`w-full h-2 rounded-lg appearance-none cursor-pointer ${
                      !isDigital ? 'bg-red-200 accent-red-500' : 'bg-slate-700 accent-green-500'
                  }`}
                />
            ...
            <div className={`p-6 rounded-2xl border transition-all duration-300 ${
                ...
                <div className="text-center">
                    <div className={`text-xs font-bold uppercase tracking-widest mb-2 ${
                        !isDigital ? 'text-red-500' : 'text-green-400'
                    }`}>
                        {!isDigital ? "Uang Melayang / Tahun" : "Potensi Profit Tambahan / Tahun"}
                    </div>
                    
                    <div
                        className={`text-3xl sm:text-4xl font-extrabold mb-1 ${
                            !isDigital ? 'text-red-600 dark:text-red-500' : 'text-white dark:text-green-400'
                        }`}
                    >
                    ...
                    <p className={`text-xs mt-2 ${!isDigital ? 'text-red-400' : 'text-slate-400'}`}>
                        {!isDigital 
                            ? "(Akibat stok hilang, salah hitung, & waktu admin terbuang)"
                            : "(Dari efisiensi stok, kecepatan layanan, & analisa data)"}
                    </p>
                </div>
            </div>
            ...
            <div className="mt-8">
                <a 
                  ...
                  className={`group w-full flex items-center justify-center gap-2 py-4 rounded-xl font-bold transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 overflow-hidden relative ${
                      !isDigital 
                ...
                >
                  <span className="relative z-10">
                    {!isDigital ? "Saya Mau Stop Kebocoran Ini" : "Saya Mau Bangun Sistem Ini"}
                  </span>
