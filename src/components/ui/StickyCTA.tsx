...
const StickyCTA: React.FC = () => {
  ...
  const handleClick = () => {
    const message = t('whatsappMessages.consultation') || 'Hi Agam, saya tertarik untuk konsultasi project';
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 md:hidden">
        <button
          onClick={handleClick}
          className="w-14 h-14 flex items-center justify-center bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full shadow-lg shadow-green-500/30 transition-all hover:scale-105 active:scale-95"
