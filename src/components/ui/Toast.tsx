    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-6 right-4 md:right-8 z-[100] bg-white dark:bg-slate-800 border border-green-500/30 shadow-2xl shadow-green-500/10 rounded-xl p-4 pr-10 flex items-start gap-3 w-[calc(100%-2rem)] md:w-auto md:min-w-[300px] max-w-md"
        >
          <div className="bg-green-100 dark:bg-green-500/20 p-2 rounded-full flex-shrink-0">
