...
const TechStack: React.FC = () => {
  ...
  return (
    <section className="py-10 bg-white dark:bg-slate-950 border-y border-slate-100 dark:border-slate-800/50 overflow-hidden">
      ...
      <div className="relative flex overflow-x-hidden group bg-white dark:bg-slate-950">
